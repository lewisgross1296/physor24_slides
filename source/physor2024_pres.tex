...
\begin{frame}{High Temperature Gas Reactors and TRISO Fuel}
    \begin{minipage}[t]{0.5\linewidth}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.85\linewidth]{figures/TRISO_diagram_Zhou_Tang.png}
...
\begin{frame}{Research Goal}
    \pause
    \begin{itemize}
        \item<2-> \textbf{What degree of TRISO homogenization is allowable to accurately compute the k-eigenvalue as a function of burnup for whole core Monte Carlo modeling?}
