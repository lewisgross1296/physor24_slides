...
\begin{frame}{Virtual Test Bed \cite{vtb2023}}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.6\linewidth]{figures/moose_logo.png}
    \end{figure}
\end{frame}
\end{withoutheadline}
...
\begin{frame}{Microreactors \cite{INL_MR}}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{figures/INL_MR.png}
    \end{figure}
\end{frame}
\end{withoutheadline}
...
\begin{frame}{High Temperature Gas Reactors and TRISO Fuel}
    ...
    \begin{minipage}[t]{0.55\linewidth}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=\linewidth]{figures/TRISO_diagram_Zhou_Tang.png}
...
\begin{frame}{Research Goal}
    \pause
    \begin{itemize}
        \item<2-> \textbf{What degree of TRISO homogenization can compute \kinf~within a reasonable $\Delta \rho$ for a full-core GCMR model?}
...
\begin{withoutheadline}
\begin{frame}{OpenMC Infinite Assembly Model: images via openmc-plotter}
